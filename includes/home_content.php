...
$memories = [
    ...
    [
        'name' => 'Mongolia',
        'img_url' => 'assets/images/locations/mongolia/homepage/mongolia.png',
        'url' => 'mongolia/memories',
    ],
    [
        'name' => 'Tibet',
        'img_url' => 'assets/images/locations/tibet/homepage/tibet.png',
        'url' => 'tibet/memories',
    ],
    [
        'name' => 'Iceland',
        'img_url' => 'assets/images/locations/iceland/homepage/iceland_memories.png',
        'url' => 'iceland/memories',
    ],
];
...
<section class="proposition">
    <div class="proposition-background">
        <img src="<?= get_image_path('assets/images/homepage/how_it_works_bg.png') ?>" alt="Mountain landscape" class="proposition-image" loading="lazy">
    </div>
    <div class="container">
        <div class="proposition-content">
            ...
            <div class="proposition-card">
                <p class="card-text">
                Every DriveOffGrid journey begins with you.
                </p>
                <div class="card-text"><strong>Your people. Your pace. Your destination.</strong></div>
                <p class="card-text">We don’t offer fixed itineraries. We design bespoke self-drive journeys shaped entirely around how you want to travel.</p>
                <div class="card-text">The experience unfolds in four simple, thoughtful steps.</div>
                <a href="how-it-works" class="btn btn-read-more">Discover the process</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="destinations-slider-wrapper">
            <div class="destinations-slider">
                <?php
                $drive_idea_index = 0;
                $total_drive_ideas = count($drive_ideas);
                foreach ($drive_ideas as $key => $drive_idea) {
                    // Load first 4 and last 4 images eagerly for proper slider initialization (forward and backward)
                    $isFirstFour = $drive_idea_index < 4;
                    $isLastFour = $drive_idea_index >= ($total_drive_ideas - 4);
                    $loading_attr = ($isFirstFour || $isLastFour) ? 'eager' : 'lazy';
                    $fetchpriority_attr = $drive_idea_index === 0 ? 'fetchpriority="high"' : '';
                ?>
                    <a href="<?= url_path('destinations/' . $drive_idea['url']) ?>" class="destination-card-link">
                        <article class="destination-card">
                            <div class="destination-image">
                                <img src="<?= get_image_path($drive_idea['hero_image']) ?>" alt="<?= $drive_idea['theme'] ?>" loading="<?= $loading_attr ?>" <?= $fetchpriority_attr ?>>
                            </div>
                            <div class="destination-overlay">
                                <div class="destination-content">
                                    <span class="destination-icon" aria-hidden="true"></span>
                                    <div class="destination-text">
                                        <h3 class="home-destination-theme destination-theme"><?= $drive_idea['theme'] ?></h3>
        ...
        <div class="memories-slider-wrapper">
            <div class="memories-slider">
                ...
                foreach ($memories as $key => $memory) {
                    // Load first 4 and last 4 images eagerly for proper slider initialization (forward and backward)
                    $isFirstFour = $memory_index < 4;
                    $isLastFour = $memory_index >= ($total_memories - 4);
                    $loading_attr = ($isFirstFour || $isLastFour) ? 'eager' : 'lazy';
                    $fetchpriority_attr = $memory_index === 0 ? 'fetchpriority="high"' : '';
                ?>
                    <a href="<?= url_path('galleries/' . explode('/', $memory['url'])[0]) ?>" class="memory-card-link">
                        <article class="memory-card">
                            <div class="memory-image">
                                <img src="<?= get_image_path($memory['img_url']) ?>" alt="<?= $memory['name'] ?>" loading="<?= $loading_attr ?>" <?= $fetchpriority_attr ?>>
                            </div>
...
<section class="plan-journey" id="book-tour">
    <div class="plan-journey-background">
        <img src="<?= get_image_path('assets/images/homepage/conttact_us_hp.jpg') ?>" alt="Mountain lake landscape" class="plan-journey-image" loading="lazy">
    </div>
        ...
        <div class="plan-journey-content">
            <div class="plan-journey-panel">
                ...
                <div class="plan-journey-cta">
                    <a href="<?php echo url_path('/contact-us'); ?>" class="btn btn-primary journey-cta-btn">REACH OUT</a>
                </div>
        ...
        <div class="about-content">
            <div class="about-text">
                ...
                <p class="about-description">
                    <strong class="highlight-text">DriveOffGrid</strong> is led by two former career professionals who, at the peak of their careers, chose the open road over corner offices. They discovered their true passion didn’t live in boardrooms. Instead, it lived behind the wheel, chasing horizons.
                </p>
                <p class="about-description">
                We don’t send people on vacations, rather we take them with us. 
                </p>
                <p class="about-description">
                Every DriveOffGrid expedition is personally led by the co-founders and shaped by experiences we truly believe in. If we wouldn’t do it ourselves, it doesn’t make it to the itinerary.                
            </p>
                <p class="about-description remove-margin-bottom">
                This isn’t just a travel company. It’s a way of life. And when you drive with us, you’re not just a guest - you’re part of our convoy.
            </p>
                <a href="founders" style="display: block; margin-top: 2rem;">
